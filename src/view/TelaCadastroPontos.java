...
public class TelaCadastroPontos extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaCadastroPontos frame = new TelaCadastroPontos();
	...
	public TelaCadastroPontos() {
		...
		JLabel lblCadastroPontos = new JLabel("Cadastrar Pontos Tur\u00EDsticos:");
		lblCadastroPontos.setFont(new Font("Arial", Font.BOLD, 17));
		lblCadastroPontos.setBounds(161, 26, 228, 14);
		contentPane.add(lblCadastroPontos);
		...
		JButton btnCadastrarPonto = new JButton("Cadastrar");
		btnCadastrarPonto.addActionListener(new ActionListener() {
		...
		btnCadastrarPonto.setFont(new Font("Arial", Font.BOLD, 12));
		btnCadastrarPonto.setBounds(227, 280, 108, 23);
		contentPane.add(btnCadastrarPonto);
